...
!(function (t, e) {
  ...
  function Fe(t, e, i) {
    ...
    var n,
      ...
      h = { x: 0, y: 0 };
    return (
      (o || (!o && !i)) && (("body" !== Ht(e) || Ae(a)) && (c = (n = e) !== $t(n) && Bt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : ye(n)), Bt(e) ? (((h = Ut(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = we(a))),
  ...
  m(ln);
  const cn = { ...ln.Default, content: "", offset: [0, 8], placement: "right", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: "click" },
