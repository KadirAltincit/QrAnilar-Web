  ...
  function B() {
    return (
      ...
      P(this.modifiers, "applyStyle") &&
        (this.popper.removeAttribute("x-placement"), (this.popper.style.position = ""), (this.popper.style.top = ""), (this.popper.style.left = ""), (this.popper.style.right = ""), (this.popper.style.bottom = ""), (this.popper.style.willChange = ""), (this.popper.style[W("transform")] = "")),
  ...
  var i = Z && window.Promise,
    ...
    ie = function () {
      ...
      return ((e = e.toString()), ne.hasOwnProperty(e))
        ? ne[e]
        : ("11" === e ? (ne[e] = -1 !== navigator.userAgent.indexOf("Trident")) : "10" === e ? (ne[e] = -1 !== navigator.appVersion.indexOf("MSIE 10")) : "all" === e ? (ne[e] = -1 !== navigator.userAgent.indexOf("Trident") || -1 !== navigator.userAgent.indexOf("MSIE")) : void 0,
          (ne.all =
            ne.all ||
